...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { amount: @bet.amount, result: @bet.result, team1: @bet.team1, team2: @bet.team2 } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { amount: @bet.amount, result: @bet.result, team1: @bet.team1, team2: @bet.team2 } }
